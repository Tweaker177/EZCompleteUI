...
- (void)setupUI {
    ...
    UIStackView *topStack = [[UIStackView alloc] initWithArrangedSubviews:@[
        self.clearButton, self.historyButton, self.clipboardButton,
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [topStack.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor constant:-16],
...
- (void)clearConversation {
    // Save current thread before wiping
    [self saveActiveThread];
